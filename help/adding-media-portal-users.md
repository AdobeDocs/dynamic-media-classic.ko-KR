...
>[!NOTE]
CSV 파일의 형식이 잘못된 경우 다음 오류 메시지가 표시됩니다. &quot;업로드된 CSV 파일을 처리하는 중 오류가 발생했습니다. 파일 컨텐츠에 유효한 데이터가 포함되어 있는지 확인하십시오.&quot; 또한 CSV에 기존 IP 또는 IPS 사용자가 포함되어 있는 경우 해당 사용자는 [사용자] 목록에 추가되지 않습니다.
...
**사용자** 활성화 및 비활성화 사용자가 폴더에 액세스하지 못하도록 일시 중단합니다. 사용자 활성화 및 비활성화를 참조하십시오.
