...
관리자는 사용자를 추가 및 관리하고, 사용자가 암호를 변경할 수 있는지 여부를 결정하고, 사용자 정보를 편집하고, 사용자 목록을 업로드할 수 있습니다. 이러한 작업은 [사용자 관리] 화면에서 수행합니다. 이 화면에 액세스하려면 다음 위치로 이동합니다. **[!UICONTROL 설정]** > **[!UICONTROL 애플리케이션 설정]** > **[!UICONTROL 관리 설정]** > **[!UICONTROL 사용자 관리]**.
...
1. 다음으로 이동 **[!UICONTROL 설정]** > **[!UICONTROL Media Portal 설정]** > **[!UICONTROL 일반 설정]**.
1. [일반 설정] 페이지에서 **[!UICONTROL [Media Portal 사용자가 암호를 변경하도록 허용]]**&#x200B;을 선택하거나 선택 취소합니다.
1. 선택 **[!UICONTROL 저장]**.

>[!NOTE]
>
>암호를 변경할 수 있는 Media Portal 사용자는 **[!UICONTROL 설정]** > **[!UICONTROL 개인 설정]** 개인 설정 화면에서 암호를 변경할 수 있습니다.

## Media Portal 사용자 추가 {#adding-a-media-portal-user}

1. 다음으로 이동 **[!UICONTROL 설정]** > **[!UICONTROL 애플리케이션 설정]** > **[!UICONTROL 관리 설정]** > **[!UICONTROL 사용자 관리]**.
1. 사용자 관리 페이지에서 **추가**.
1. 사용자 추가 대화 상자의 사용자 정보 패널에서 사용자의 이름, 성 및 전자 메일 주소를 입력한 다음 **[!UICONTROL 다음]**.
...
1. [액세스 그룹] 패널에서 하나 이상의 그룹을 선택합니다.
   ...
   자세한 내용은 [Media Portal 그룹 만들기 및 관리](creating-media-portal-groups.md#creating_and_managing_media_portal_groups).

1. (선택 사항) 선택 **[!UICONTROL 전자 메일 설정]** 기본 설정과 다른 이메일 설정을 선택하려면 다음을 수행하십시오.
...
1. 업로드할 파일 선택 대화 상자에서 CSV 파일을 선택한 다음 을 선택합니다 **[!UICONTROL 열기]**.
...
1. 다음으로 이동 **[!UICONTROL 설정]** > **[!UICONTROL 애플리케이션 설정]** > **[!UICONTROL 관리 설정]** > **[!UICONTROL 사용자 관리]**.
1. 에서 **[!UICONTROL 사용자 역할별]** 드롭다운 목록에서 Media Portal 사용자 역할의 이름을 선택하고 **[!UICONTROL 새로 고침]** 를 입력하여 Media Portal 사용자의 한 클래스의 이름을 표시합니다.
1. 선택 **[!UICONTROL 팝업 목록]**. 이 목록을 복사하여 붙여넣습니다.

## Media Portal 사용자에 대한 환영 이메일 메시지 설정 {#setting-up-the-welcome-e-mail-message-for-media-portal-users}

새 Media Portal 사용자, 기여자 및 기여자-사용자를 추가할 때 환영 이메일을 보낼 수 있습니다. 이 이메일 메시지를 구성하거나 Adobe Dynamic Media Classic에 보내지 않도록 요청할 수 있습니다.

1. 다음으로 이동 **[!UICONTROL 설정]** > **[!UICONTROL 애플리케이션 설정]** > **[!UICONTROL 관리 설정]** > **[!UICONTROL 사용자 관리]**.
1. 사용자 관리 설정 화면에서 을 선택합니다 **[!UICONTROL 전자 메일 설정]**.
1. [이메일 설정] 대화 상자에서 다음 중 원하는 설정을 지정합니다.

   * **[!UICONTROL 이메일 보내기]** - 새 사용자에게 등록한 전자 메일을 통해 알리지 않으려면 이 옵션을 선택 취소합니다.

   * **[!UICONTROL 기본 암호]** - 새 사용자의 임시 암호를 입력하거나, Adobe Dynamic Media Classic에서 임의 암호를 생성하도록 필드를 비워 둡니다. 사용자는 처음 로그인할 때 암호를 변경하라는 메시지가 표시됩니다.
...
* **[!UICONTROL 사용자 활성화 및 비활성화]** - 사용자의 폴더 액세스를 일시 중단합니다.

* **[!UICONTROL 사용자 정보 편집]** - 사용자에 대한 최신 정보를 입력합니다.

* **[!UICONTROL 사용자 정의 필드 만들기]** - Adobe Dynamic Media Classic에서 자산을 구성하는 데 도움이 되도록 사용자 정의 메타데이터 필드를 만듭니다. 또한 이 필드는 필요에 따라 활성화되거나 비활성화될 수 있습니다.
