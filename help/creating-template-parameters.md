...
1. 선택 **[!UICONTROL 닫기]** 매개 변수 화면을 종료하려면 다음을 수행하십시오.

>[!NOTE]
>
>[매개 변수] 화면에서 매개 변수 이름을 바꿀 수 있습니다. 매개 변수 이름을 바꾸면 URL 문자열에서 매개 변수를 더 쉽게 식별할 수 있으며 더 편리하게 데이터베이스 값으로 사용할 수 있습니다. 매개 변수의 이름을 변경하려면 해당 매개 변수를 선택합니다 **[!UICONTROL 설정]** 옵션을 선택하고 이름을 선택한 다음 이름 필드에 새 이름을 입력합니다.
...
1. 을(를) 선택합니다 **[!UICONTROL 설정]** text 속성(textAttr) 이름 옆에 있는 옵션입니다.
1. 을(를) 선택합니다 **[!UICONTROL 텍스트]** 탭 을 클릭합니다.
1. 선택 **[!UICONTROL 매개 변수 추가]**. 기본 매개 변수 이름이 나타납니다. 이 이름을 선택하고 위에 입력하여 이름을 바꿀 수 있습니다. 현재 텍스트 문자열이 매개 변수의 새 이름이 됩니다.
1. 선택 **[!UICONTROL 닫기]** 매개 변수 페이지를 닫으려면 를 클릭합니다.
