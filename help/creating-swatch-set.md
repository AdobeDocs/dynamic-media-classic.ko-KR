...
|&quot;저장 후 게시&quot; 옵션을 선택한 다음?|저장 후 설정 상태|저장 후 세트 멤버 상태|
|— |— |— |
|예|게시됨|게시됨|
...
1. 다음 중 하나를 수행하십시오.
   ...
   **이미지를** 먼저 선택합니다. [찾아보기] 패널에서 이미지를 선택한 다음 [작성] > [견본 집합]을 클릭합니다.

   **견본 집합 화면에서 시작작성** > 견본 집합을 클릭합니다. 자산 라이브러리에서 폴더를 선택하고 이미지를 [견본 집합] 페이지의 [보기] 섹션으로 드래그합니다.
