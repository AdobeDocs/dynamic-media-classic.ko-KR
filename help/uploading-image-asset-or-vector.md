...
* 파일 크기 제한.
* 파일 이름 확장자 목록.
* 자산과 연결된 색상 프로필 및 파일 이름을 유지할지 여부.
* 녹아웃 배경을 사용할지 여부를 지정합니다. [배경 녹아웃]을 활성화하면 [모퉁이], [허용치] 및 [채우기 방법]을 설정합니다. 업로드 [시 이미지 편집 옵션에서 배경](image-editing-options-upload.md#image-editing-options-at-upload)녹아웃을 참조하십시오.
* 업로드할 파일 이름
...
다음 링크를 클릭하여 위의 양식과 연결된 HTML 소스 코드를 볼 수 있습니다.
