...
1. **[!UICONTROL 빌드]** 드롭다운 메뉴에서 **[!UICONTROL 스핀 세트]**&#x200B;를 선택합니다.
...
1. 스핀 세트의 롤오버 **[!UICONTROL 편집]** 단추를 선택합니다.
1. 다음 중 하나를 수행합니다.
   ...
   * **행 순서 재지정(2차원 스핀 세트)**  - 행 선택기 상자(행 왼쪽)를 선택한 다음  **[!UICONTROL 행]** 이동 또는  **[!UICONTROL 행 위로 이동]**&#x200B;을 선택합니다.
