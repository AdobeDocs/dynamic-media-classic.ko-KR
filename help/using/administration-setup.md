...
* **잘못된 사용자 필터링** - 선택 취소 **[!UICONTROL 잘못된 포함]**. 시스템에 있는 사용자만 검색 결과에 표시됩니다. 시스템 및 관리하는 계정에서 잘못된 사용자가 삭제되었습니다.

* **열 머리글별 정렬** - 모든 사용자를 이름, 성, 전자 메일, 사용자 역할 또는 유효/무효 상태별로 알파벳순으로 정렬하려면 머리글을 선택합니다.
...
* **기간 지정** - 보고서 기간을 정의할 옵션을 선택한 다음 다음을 선택합니다. **[!UICONTROL 업데이트]** 기간을 정의한 후:
...
* **보고서 데이터 내보내기** - 데이터 보기에서 필요에 따라 데이터를 정렬 및 정렬합니다. 그런 다음 를 엽니다. **[!UICONTROL 내보내기]** 메뉴를 클릭하고 형식을 선택합니다. **[!UICONTROL 탭으로 구분됨]**, **[!UICONTROL 쉼표로 구분됨]**, 또는 **[!UICONTROL HTML 서식 지정됨]**. 선택한 형식으로 데이터가 클립보드에 복사됩니다. 이제 스프레드시트나 기타 애플리케이션에 데이터를 붙여 넣을 수 있습니다.
...
* **시간** - 오류가 처음 보고된 시간부터 마지막 오류가 보고된 시간까지의 시간 범위입니다(지난 24시간 이내).
...
* **레퍼러** - 초기 요청이 발생한 웹 사이트의 URL을 지정합니다. 레퍼러는 이미지 링크가 있는 임의 웹 사이트일 수 있습니다.
