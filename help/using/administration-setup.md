...
1. 사용자 설정을 완료하려면 **[!UICONTROL 저장]**&#x200B;을 선택하세요.
   ...
   새 사용자를 추가하면 시작 이메일이 전송됩니다. 이메일은 임시 암호를 제공하며 Adobe Dynamic Media Classic에 로그인하는 방법을 설명합니다.

   환영 이메일을 받지 못한 사용자는 Adobe Dynamic Media Classic 로그인 페이지(https://s7sps1.scene7.com)로 이동하여 **[!UICONTROL 내 암호 찾기]**&#x200B;를 선택합니다. 암호가 재설정되고 새 이메일이 전송됩니다. 사용자가 이메일을 받지 못했고 스팸 폴더에 없는 경우 기술 지원에 문의하십시오.
...
* **필드 이름별로 필터링**: **[!UICONTROL 필드별로 필터링 사용]**&#x200B;을 선택합니다. **[!UICONTROL 필드 이름별]** 메뉴를 선택하고 목록을 필터링할 열을 선택한 다음 문자 필터 메뉴를 선택하고 문자를 선택합니다. 선택한 편지는 열 중 하나의 목록을 필터링합니다. 전체 목록을 보려면 **`Enable Filter By Field`** 옵션을 선택 취소하십시오.

* **잘못된 사용자 필터링**: **[!UICONTROL 잘못된 사용자 포함]**&#x200B;을 선택 취소합니다. 시스템에 있는 사용자만 검색 결과에 표시됩니다. 시스템 및 관리하는 계정에서 잘못된 사용자가 삭제되었습니다.

* **열 머리글별로 정렬**: 상태, 이름, 성 또는 전자 메일별로 모든 사용자를 정렬할 머리글을 선택합니다. 또는 사용자 역할 또는 유효/무효 상태별로 정렬합니다.
...
### 데이터 표시 옵션 구성 {#viewing-data-in-different-ways}
...
* **보고서 프레젠테이션 형식을 선택하십시오**: 보고서 형식 메뉴에서 **[!UICONTROL 요약]**, **[!UICONTROL 일별]** 또는 **[!UICONTROL 월별]**&#x200B;을 선택하여 요약, 일 또는 월별로 데이터를 구성하십시오. 모든 보고서에서 이 선택 사항을 제공하는 것은 아닙니다.
...
* **사용자 지정 기간**: 미리 정의된 보고서 메뉴에서 **[!UICONTROL 사용자 지정]**&#x200B;을 선택합니다. 그런 다음 **[!UICONTROL 월 시작]**(또는 **[!UICONTROL 시작 날짜]**) 메뉴에서 날짜를 선택하고 # of Months(또는 # of Days) 메뉴에서 날짜를 선택합니다. 도메인 및 비디오 컨텐츠 보고서의 경우 보고서 정보를 캡처할 특정 시작 날짜와 종료 날짜를 선택할 수 있습니다.
...
1. 다음 중 하나를 수행합니다(선택 사항).
   ...
   * 링크를 실제 이미지로 복사하려면 **[!UICONTROL URL 복사]**&#x200B;를 선택하십시오. 이미지로 이동하여 오류를 조사하려면 브라우저 창에 이 링크를 붙여넣습니다.
...
* **Time**: 오류가 처음 보고된 시간부터 마지막으로 오류가 보고된 시간까지의 시간 범위입니다. 지난 24시간 이내에 해당됩니다.
