...
* **열 머리글별 정렬**: 모든 사용자를 이름, 성 또는 이메일별로 알파벳순으로 상태별로 정렬하려면 머리글을 선택합니다. 또는 사용자 역할별로 정렬하거나 유효/무효 상태별로 정렬합니다.
...
* **데이터 정렬(데이터 보기 전용)**: 열의 정보를 정렬합니다. 열의 제목을 선택합니다. 내림차순으로 정렬하려면 다시 선택하십시오.
