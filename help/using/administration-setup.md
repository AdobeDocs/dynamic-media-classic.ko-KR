...
관리 설정 화면은 Adobe Dynamic Media Classic 사용자를 관리하기 위한 것입니다. 이 화면을 사용하여 사용자가 Adobe Dynamic Media Classic에서 작업할 수 있고 사용자와 이메일을 통해 통신할 수 있습니다.

1. 관리 설정 옵션에 액세스하려면 **설정** > **개인 설정** > **관리 설정**.
...
**Adobe Dynamic Media Classic 사용자** 할당된 회사에 액세스할 수 있으며 관리 업무를 수행할 수 없습니다.

**Adobe Dynamic Media Classic 회사 관리자** 자신의 회사만 보고 관리할 수 있습니다. 회사 관리자는 관리자 및 사용자 추가를 비롯한 모든 관리 기능을 수행할 수도 있습니다. 회사 관리자는 DMC 회사 관리 계정에 사용자를 추가할 수 있습니다. 이 역할이 기본 사용자 역할입니다.
...
1. 선택 **[!UICONTROL 추가]**.
1. 추가할 사용자 또는 관리자의 이름과 이메일 주소를 입력한 다음 을(를) 선택합니다 **[!UICONTROL 다음]**.
...
1. 사용자에게 역할을 할당하려면 역할 옵션을 선택합니다.
   ...
   다음을 참조하십시오 [Adobe Dynamic Media Classic 사용자 역할 및 권한](administration-setup.md#user_administration).

1. 회사에 사용자를 추가하려면 회사 이름을 선택합니다.
1. 사용자를 그룹에 추가하려면(Media Portal 사용자 또는 기여자를 추가하는 경우) 다음을 선택합니다. **[!UICONTROL 다음]** 사용자를 추가합니다.
1. 선택 **[!UICONTROL 저장]** 을 클릭하여 사용자 설정을 완료합니다.

   저장하면 사용자를 다른 회사에 추가할 것인지 묻는 메시지가 나타납니다. 선택 **[!UICONTROL 추가]** 사용자를 회사에 추가하려는 경우.
...
1. 다음으로 이동 **[!UICONTROL 설정]** > **[!UICONTROL 응용 프로그램 설정]** > **[!UICONTROL 관리 설정]** > **[!UICONTROL 사용자 관리]**.
1. 사용자 목록에서 를 선택하거나 선택 취소합니다. **[!UICONTROL 활성]** 사용자 이름 옆에 있는 옵션입니다.
...
1. 다음으로 이동 **[!UICONTROL 설정]** > **[!UICONTROL 응용 프로그램 설정]** > **[!UICONTROL 관리 설정]** > **[!UICONTROL 사용자 관리]**.
1. 목록에서 사용자를 선택한 다음 을 선택합니다 **[!UICONTROL 편집]**.
1. 테이블에서 권한 또는 액세스 권한을 수정하려는 회사를 표시하는 항목을 선택한 다음 을 선택합니다 **[!UICONTROL 회사 관리]**.
1. 사용자 역할을 선택합니다.
1. 사용자의 그룹 구성원을 변경하려면(Media Portal 사용자 또는 기여자를 편집하거나 추가하는 경우) 다음을 선택합니다 **[!UICONTROL 다음]** 그룹 멤버십을 편집합니다.
1. 선택 **[!UICONTROL 저장]**.
...
* **그룹으로 필터링**: 다음을 선택합니다. **[!UICONTROL 그룹별]** 을 클릭하고 옵션을 선택하여 그룹의 사용자로 목록을 좁힐 수 있습니다.

* **사용자 역할로 필터링**: 다음을 선택합니다. **[!UICONTROL 사용자 역할별]** 을 클릭하고 옵션을 선택하여 다른 유형의 사용자 또는 관리자로 목록을 좁힐 수 있습니다.

* **필드 이름으로 필터링**: 선택 **[!UICONTROL 필드별 필터링 활성화]**. 그런 다음 를 선택합니다. **[!UICONTROL 필드 이름별]** 메뉴에서 목록을 필터링할 열을 선택하고 문자 필터 메뉴를 선택한 다음 문자를 선택합니다. 선택한 문자로 열 중 하나에서 목록이 필터링됩니다. 전체 목록을 보려면 **[!UICONTROL 필드별 필터링 활성화]** 옵션을 선택합니다.

* **잘못된 사용자 필터링**: 선택 해제 **[!UICONTROL 잘못된 포함]**. 시스템에 있는 사용자만 검색 결과에 표시됩니다. 시스템 및 관리하는 계정에서 잘못된 사용자가 삭제되었습니다.

* **열 머리글별 정렬**: 모든 사용자를 이름, 성 또는 이메일, 사용자 역할 또는 유효/무효 상태별로 알파벳순으로 상태 기준으로 정렬하려면 머리글을 선택합니다.
...
이 페이지를 열려면 다음으로 이동 **[!UICONTROL 설정]** > **[!UICONTROL 개인 설정]**. 확장 **[!UICONTROL 관리 설정]**&#x200B;을 선택한 다음 을 선택합니다 **[!UICONTROL 대역폭 및 저장소]**.
...
* **썸네일 요청**: 뷰어의 견본 또는 대체 이미지에 대한 요청입니다.

* **마스크 요청**: 회색 음영 마스크를 반환하는 이미지에 대한 요청입니다.

* **뷰어 타일 요청**: 뷰어에서 로드한 이미지 요청입니다.

* **Vnt 개체 요청**: 요청된 비네팅에 지정된 개체가 있는 이미지를 반환하는 이미지 렌더링 요청.
...
1. 다음으로 이동 **[!UICONTROL 설정]** > **[!UICONTROL 개인 설정]**.
1. 관리 설정을 확장한 다음 을 선택합니다. **[!UICONTROL 대역폭 및 저장소]**.
1. 탭을 선택합니다. **[!UICONTROL 대역폭]**, **[!UICONTROL 스토리지]**, **[!UICONTROL 이미지 컨텐츠]**, **[!UICONTROL 도메인]**, **[!UICONTROL 비디오 스트리밍]**, 또는 **[!UICONTROL 비디오 콘텐츠]**.
...
* **차트 또는 데이터 그리드에서 데이터 보기**: 선택 **[!UICONTROL 차트 보기]** 차트에서 데이터를 보려면 다음을 선택합니다. **[!UICONTROL 데이터 보기]** 를 클릭하여 데이터 그리드에서 데이터를 볼 수 있습니다.

* **보고서 프레젠테이션 유형 선택**: 보고서 유형 메뉴에서 **[!UICONTROL 요약]**, **[!UICONTROL 매일]**, 또는 **[!UICONTROL 월별]** 요약 형식으로, 일별 또는 월별로 데이터를 구성합니다. 모든 보고서에서 이 선택 사항을 제공하는 것은 아닙니다.

* **기간 지정**: 보고서 기간을 정의할 옵션을 선택한 다음 선택합니다 **[!UICONTROL 업데이트]** 기간을 정의한 후:

* **사전 정의된 기간**: 사전 정의된 보고서 메뉴에서 옵션을 선택합니다. 예를 들어 전달의 데이터를 캡처하려면 [지난 달]을 선택합니다.

* **사용자 정의 기간**: 사전 정의된 보고서 메뉴에서 **[!UICONTROL 사용자 정의]**. 그런 다음 날짜에서 선택 **[!UICONTROL 시작 월]** (또는 **[!UICONTROL 시작일]**) 메뉴 및 날짜가 # of Months(또는 # 또는 Days) 메뉴에 표시됩니다. 도메인 및 비디오 컨텐츠 보고서의 경우 보고서 정보를 캡처할 특정 시작 날짜와 종료 날짜를 선택할 수 있습니다.

* **데이터 정렬(데이터 보기 전용)**: 열에 대한 정보를 정렬하려면 열의 머리글을 선택합니다. 내림차순으로 정렬하려면 다시 선택하십시오.
...
* **보고서 데이터 내보내기**: 데이터 보기에서 데이터를 필요에 따라 정렬하고 정렬합니다. 그런 다음 를 엽니다. **[!UICONTROL 내보내기]** 메뉴를 클릭하고 형식을 선택합니다. **[!UICONTROL 탭으로 구분됨]**, **[!UICONTROL 쉼표로 구분됨]**, 또는 **[!UICONTROL HTML 서식 지정됨]**. 선택한 형식으로 데이터가 클립보드에 복사됩니다. 이제 스프레드시트나 기타 애플리케이션에 데이터를 붙여 넣을 수 있습니다.

* **보고서 인쇄**: 선택 **[!UICONTROL 인쇄]**&#x200B;를 클릭하고 [인쇄] 대화 상자에서 원하는 옵션을 선택한 다음 를 선택합니다 **[!UICONTROL 확인]**.
...
1. 다음으로 이동 **[!UICONTROL 설정]** > **[!UICONTROL 개인 설정]**.
1. 관리 설정을 확장한 다음 을 선택합니다. **[!UICONTROL 이미지 오류]**.
1. 다음 중 하나를 수행합니다(선택 사항).
   ...
   * 레퍼러 웹 페이지에 링크를 복사하려면 다음을 선택합니다. **[!UICONTROL 레퍼러 복사 URL]**.

현재 로그인한 회사에 대해 오류가 표시됩니다. 각 오류에는 다음 정보가 포함됩니다.

* **이미지 ID**: 문제가 있는 이미지의 ID입니다.

* **시간**: 처음 오류가 보고된 시간부터 마지막 오류가 보고된 시간까지의 시간 범위입니다. 지난 24시간 내에 해당됩니다.

* **카운트**: 이미지에 보고된 오류 수.

* **응답**: 특정 오류 메시지. 오류는 4xx 또는 5xx입니다.

* **URL**: Adobe Dynamic Media Classic에 있는 이미지의 URL을 나열합니다.
