...
이미지 세트의 이미지에 대해 [확대/축소 대상] 및 [이미지 맵]을 정의하면 이러한 대상 및 맵이 이미지 세트 뷰어에 나타납니다. 예를 들어 사용자는 이미지 세트 뷰어에서 이미지 맵을 선택하고 항목에 대한 정보가 있는 웹 사이트에서 새 페이지를 열 수 있습니다. 사용자는 이미지 세트 뷰어에서 대상 썸네일 이미지를 선택하고 이미지의 특정 영역으로 자동으로 확대/축소할 수 있습니다.
