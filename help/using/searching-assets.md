...
* **모든 게시 상태**: 게시 준비됨으로 표시되거나, 게시 준비됨으로 표시되지 않은 파일 또는 모든 파일을 검색합니다.
...
* **필터 작업 저장**: 다음으로 이동 **[!UICONTROL 사전 설정 선택]** > **[!UICONTROL 현재 항목을 새 사전 설정으로 저장]**&#x200B;을(를) 클릭한 다음 **[!UICONTROL 저장]** 대화 상자.
...
* **[!UICONTROL 즉시 게시]**: 새 에셋, 키워드 변경 등을 포함하여 메타데이터 변경 사항이 적용되면 자동으로 푸시합니다.
