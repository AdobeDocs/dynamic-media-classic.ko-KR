---
title: Dynamic Media Classic Assets 검색
...
검색할 때 특정 형식의 파일만 보려면 왼쪽의 자산 라이브러리에 있는 **[!UICONTROL 표시]** 드롭다운 목록에서 파일 형식을 선택하십시오. 표시하기로 선택한 유형의 자산만 자산 라이브러리에 표시됩니다.

>[!NOTE]
>
>Asset Library 패널이 숨겨져 있는 경우, Dynamic Media Classic 창 가운데에 있는 오른쪽 삼각형 화살표를 클릭하여 표시합니다.

## 찾아보기 패널에서 파일 정렬 {#sorting-files-in-the-browse-panel}

[찾아보기] 패널에 나타나는 폴더 또는 검색 결과의 내용을 정렬할 수 있습니다. 전역 탐색 모음에서 **[!UICONTROL 정렬]**&#x200B;을 선택한 다음 옵션을 선택하십시오. 옵션은 **[!UICONTROL 이름]**, **[!UICONTROL 크기(KB)]**, **[!UICONTROL 유형]**, **[!UICONTROL 만든 날짜]** 및 **[!UICONTROL 마지막으로 수정한 날짜]**&#x200B;입니다.

**[!UICONTROL 오름차순]** 또는 **[!UICONTROL 내림차순]**&#x200B;을 선택하여 선택한 기준별로 자산을 오름차순 또는 내림차순으로 정렬할 수도 있습니다.
...
1. 자산 라이브러리의 **[!UICONTROL 폴더]** 패널에서 특정 폴더 및 그 하위 폴더에서 검색할 폴더를 선택합니다.
1. 자산 라이브러리의 검색 필드 왼쪽에서 **[!UICONTROL 검색]** 아이콘을 선택하여 드롭다운 목록을 엽니다.
1. 드롭다운 목록에서 원하는 검색 범위를 설명하는 옵션을 선택합니다. **[!UICONTROL 모든 파일 및 폴더에서]**, **[!UICONTROL 선택한 폴더에서]** 또는 **[!UICONTROL 선택한 폴더 및 하위 폴더에서]**&#x200B;을(를) 선택할 수 있습니다.
1. 검색 필드에 검색어를 입력합니다.
1. 검색 필드 오른쪽에서 **[!UICONTROL 이동]**&#x200B;을 선택하거나 **[!UICONTROL Enter]**&#x200B;을 누릅니다.
...
검색 필드 바로 아래에 있는 자산 라이브러리에서 **[!UICONTROL 고급 검색]**&#x200B;을 선택하여 메타데이터 필드의 값을 비롯한 다양한 기준을 사용하여 검색합니다.

고급 검색에서 다음 기준 중 하나를 지정합니다.

* **자산 유형별로 필터링**: 검색 범위를 하나의 자산 유형으로만 좁힙니다. 메뉴에서 에셋 유형을 선택합니다.

* **파일 및 폴더**: 검색할 위치 선택: **[!UICONTROL 모든 파일 및 폴더]**, **[!UICONTROL 선택한 폴더]** 또는 **[!UICONTROL 선택한 폴더 및 하위 폴더]**.

* **모든 게시 상태**: 게시 준비됨으로 표시되어 있거나 게시 준비됨으로 표시되어 있지 않은 파일 또는 모든 파일을 검색합니다.

* **조건**: 검색할 메타데이터 조건을 지정하는 경우 검색이 모든 조건(ALL 검색)과 일치해야 하는지 아니면 모든 조건(OR 검색)과 일치해야 하는지 여부를 선택합니다.

* **검색 조건**: 메타데이터 검색을 위한 검색 필드를 하나 이상 만듭니다. 검색 필드를 만들려면

  1. 고급 검색에서 **[!UICONTROL 검색 조건]** 제목 아래의 **[!UICONTROL 필드 추가]** 메뉴 왼쪽에서 아래쪽 삼각형 화살표 아이콘을 선택하여 드롭다운 목록을 엽니다. 메타데이터 보기를 선택합니다. **[!UICONTROL 값이 있는 모든 속성]**, **[!UICONTROL 작게 보기]**, **[!UICONTROL IPTC]**, **[!UICONTROL 메타데이터 서버 게시 필드]** 또는 **[!UICONTROL XMP]**&#x200B;을(를) 선택할 수 있습니다.
...
[고급 검색] 패널의 오른쪽 아래 모서리에서 **[!UICONTROL 검색]**&#x200B;을 선택하여 검색을 시작합니다. 검색 결과가 오른쪽의 찾아보기 패널에 나타납니다. 검색 조건을 변경하고 **[!UICONTROL 검색]**&#x200B;을 선택하여 검색을 다시 실행할 수 있습니다.

검색 조건을 지우고 새 검색을 시작하려면 **[!UICONTROL 지우기]**&#x200B;를 선택하십시오. 검색을 마치면 **[!UICONTROL 닫기]**&#x200B;를 선택하여 검색 패널을 닫습니다.
...
필터 작업을 여러 번 실행하려면 필터 작업을 저장할 수 있습니다.
...
1. 자산 라이브러리에서 **[!UICONTROL 필터]** 탭을 선택합니다.
   ...
   이전 필터 작업의 기준이 [필터] 창에 표시됩니다. 필터 창은 패널로 나뉘며, 각 패널은 메타데이터 필드를 나타냅니다. 패널을 사용하여 필터링할 메타데이터 필드를 선택하고, 각 필드 내에서 필터 작업에 사용할 메타데이터 값을 선택합니다.
...
1. 패널에서 **[!UICONTROL 필드]**&#x200B;를 클릭한 다음 다음 지침을 따라 필터링 메뉴를 표시하고 필터 작업을 구성할 수 있습니다.
   ...
   * **메타데이터 필드 추가**: **[!UICONTROL 패널 추가]**&#x200B;를 선택합니다. [필터] 창에 패널이 나타나면 해당 **[!UICONTROL 필드]** 단추를 선택하고 필터링 메뉴에서 메타데이터 필드의 이름을 선택합니다.

   * **메타데이터 필드 제거**: 필터링 메뉴에서 **[!UICONTROL 이 패널 제거]**&#x200B;를 선택합니다.
...
1. 각 패널에서 필터링할 메타데이터 값을 선택합니다. 각 패널에서 두 개 이상의 메타데이터 값을 선택할 수 없습니다.
   ...
   선택한 모든 값과 일치하는 Assets이 [찾아보기] 패널에 나타납니다.

   >[!NOTE]
   >
   >**[!UICONTROL 모두 선택 해제]**&#x200B;를 클릭하여 필터 작업에서 필드를 일시적으로 제거합니다. 이 옵션은 각 패널의 맨 위, 메타데이터 값 위에 있습니다.

1. (선택 사항) 필터 작업을 저장하고 나중에 실행하려면 **[!UICONTROL 사전 설정 선택]** > **[!UICONTROL 현재 설정을 새 사전 설정으로 저장]**&#x200B;을 선택한 다음 **[!UICONTROL 저장]** 대화 상자에 이름을 입력합니다.

### 필터 작업 저장, 반복 및 삭제 {#saving-repeating-and-deleting-filter-operations}

필터 작업을 저장, 반복 및 삭제할 수 있도록 필터 탭에서 다음 지침을 따르십시오.

* **필터 작업 저장**: **[!UICONTROL 사전 설정 선택]** > **[!UICONTROL 현재 설정을 새 사전 설정으로 저장]**(으)로 이동한 다음 **[!UICONTROL 저장]** 대화 상자에 이름을 입력하십시오.

* **필터 작업 반복**: **[!UICONTROL 사전 설정 선택]**&#x200B;을 선택하고 메뉴에서 필터 작업의 이름을 선택합니다. 저장한 필터 작업이 메뉴에 나열됩니다.

* **사전 설정 선택 메뉴에서 필터 작업을 삭제합니다**: 필터 작업을 실행합니다. 그런 다음 메뉴에서 **[!UICONTROL 사전 설정 선택]** > **[!UICONTROL 사전 설정 삭제]**(으)로 이동합니다.

## 메타데이터 서버 사용 {#using-the-metadata-server}

메타데이터 서버는 http 요청을 사용하여 메타데이터별로 에셋을 검색하는 데 사용할 수 있는 공개 API입니다.
...
* **[!UICONTROL 즉시 게시]**: 새 에셋, 키워드 변경 및 기타 관련 항목을 포함한 메타데이터 변경 사항이 있을 때 자동으로 푸시됩니다.
