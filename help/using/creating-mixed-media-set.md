...
1. **[!UICONTROL 빌드]** > **[!UICONTROL 혼합 미디어 집합]**(으)로 이동합니다.
1. 비디오, 이미지 집합, 회전 집합 및 견본을 자산 라이브러리에서 [혼합 미디어 집합] 화면으로 드래그합니다.

   >[!NOTE]
   >
   >혼합 미디어 집합은 `( ) { }` 문자를 포함하는 파일 이름이 있는 자산을 지원하지 않습니다.
...
1. 혼합 미디어 집합의 롤오버 **[!UICONTROL 편집]** 단추를 선택합니다.
1. 다음 중 하나를 수행합니다.

   * 항목을 제거하려면 항목을 선택하고 **[!UICONTROL 삭제]**&#x200B;를 선택합니다.
