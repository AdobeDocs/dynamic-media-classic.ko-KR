...
Adobe Dynamic Media Classic 화면에는 전역 탐색 막대, 에셋 라이브러리, 에셋 필터 탭, 찾아보기 패널/빌드 패널 및 Media Cart(Media Portal에만 해당)의 5가지 주요 영역이 포함되어 있습니다.

![탐색 기본 사항](/help/using/assets/gs_navigation_basics_popup_popup.png)
*기본 Adobe Dynamic Media Classic 영역*
*A) 전역 탐색 모음, B) 자산 라이브러리, C) 자산 필터 탭, D) 검색 패널, E) 미디어 카트(Media Portal만 해당)*
...
* **[!UICONTROL 설치]**: [!DNL Adobe Dynamic Media Classic] 사용을 최적화하기 위해 설치 또는 관리 옵션을 선택할 수 있도록 설치 화면을 엽니다. [[설정]](/help/using/setup-basics.md)을 참조하십시오.
...
* **[!UICONTROL 도움말]** 도움말 옵션 선택
  ...
  * **[!UICONTROL 도움말 목차]**: 소개 페이지의 도움말 시스템을 엽니다. 다른 주제를 찾아 보려면 목차를 통해 검색할 수 있습니다.
  * **[!UICONTROL 정보]**: 실행 중인 Adobe Dynamic Media Classic 버전을 표시합니다.
  * **[!UICONTROL 지원]**: Adobe Dynamic Media Classic에 대한 기술 지원을 받는 방법에 대한 정보를 제공합니다.
...
에셋 라이브러리 패널의 맨 위에는 에셋을 찾는 명령이 있습니다. 에셋을 찾으려면 에셋을 검색하고 필터링할 수 있습니다. 삭제한 자산을 검사하려면 자산 라이브러리 아래쪽에 있는 **[!UICONTROL 휴지통]** 아이콘을 선택합니다.

>[!NOTE]
>
>**[!UICONTROL 자산 라이브러리]** 컨트롤을 선택하여 자산 라이브러리를 열거나 닫고 사용 가능한 작업 영역을 확장할 수 있습니다. 패널을 확장하거나 축소하려면 **[!UICONTROL 확장]**/**[!UICONTROL 축소]** 컨트롤을 선택하십시오. 이러한 컨트롤은 패널의 왼쪽에 있습니다.

## 찾아보기 패널/빌드 패널 {#browse-panel-build-panel}

찾아보기/빌드 패널에서는 많은 작업을 실행합니다. 이 패널에서 사용할 수 있는 기능은 찾아보기 모드인지 빌드 모드인지에 따라 다릅니다.

* **[!UICONTROL 찾아보기 모드]**: [찾아보기] 패널에서 폴더 내용을 보고 작업할 수 있습니다. 자산 라이브러리에서 폴더를 선택합니다. 이 패널에서는 에셋 작업을 위한 **[!UICONTROL 파일]**, **[!UICONTROL 미리 보기]**, **[!UICONTROL 모두 선택]**, **[!UICONTROL 없음 선택]** 및 **[!UICONTROL 정렬]** 메뉴를 제공합니다. 슬라이더를 이동하거나 **[!UICONTROL 눈금 보기]**, **[!UICONTROL 목록 보기]** 또는 **[!UICONTROL 세부 정보 보기]**&#x200B;를 선택하여 다른 방법으로 자산을 볼 수도 있습니다. **[!UICONTROL 세부 보기]**&#x200B;를 선택하거나 자산을 두 번 클릭하면 자산에 종속된 파일 작업을 수행할 수 있는 세부 보기에서 자산이 열립니다.
