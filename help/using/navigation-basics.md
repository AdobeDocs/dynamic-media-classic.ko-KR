...
* **[!UICONTROL 업로드]**: 컴퓨터 또는 네트워크의 파일을 Adobe Dynamic Media Classic에 업로드할 수 있도록 업로드 화면을 엽니다. 데스크탑에서 또는 FTP를 통해 파일을 업로드할 수 있습니다. [파일 업로드](/help/using/uploading-files.md)를 참조하십시오.
