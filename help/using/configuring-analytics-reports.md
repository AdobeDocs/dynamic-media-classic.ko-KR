...
뷰어 이벤트는 사용자가 Adobe Dynamic Media Classic 뷰어로 수행하는 작업을 설명합니다. 사용자가 썸네일을 선택하거나 비디오를 시작하거나 중지하는 등의 특정 작업을 시작하면 뷰어가 해당 이벤트와 관련된 데이터와 함께 이벤트를 웹 페이지에 &quot;브로드캐스트&quot;합니다.
