...
* [릴리스 노트](https://experienceleague.adobe.com/ko/docs/dynamic-media-developer-resources/release-notes/s7rn2017)
...
## Adobe Dynamic Media Classic 뉴스레터, 튜토리얼 및 웨비나
...
* [Adobe Dynamic Media Classic에서 SEO를 지원하는 방법](/help/using/assets/s7_seo.pdf): Adobe Dynamic Media Classic은 검색 엔진의 이미지를 최적화하여 웹 사이트의 트래픽을 높입니다. 이 PDF은 이러한 결과를 얻기 위한 배경 및 구현 지침을 제공합니다.
...
* [Adobe Dynamic Media Classic을 사용하여 대화형 환경을 제공하는 모범 사례](https://seminars.adobeconnect.com/p7wb8ej3u6d/): 이 웨비나는 Adobe Dynamic Media Classic을 사용하여 콘텐츠를 가져오고 내보내는 방법을 알려줍니다. 최적의 성능과 경험을 위해 이미지 사전 설정을 설정하는 방법에 대해 알아봅니다. 뷰어 사전 설정 및 캐싱 구성에 대해서도 알아봅니다.
