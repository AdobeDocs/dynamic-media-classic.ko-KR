...
템플릿의 경우 다음을 선택합니다. **[!UICONTROL 추가 및 미리 보기]**&#x200B;를 클릭한 다음 선택한 매개 변수를 설정합니다. 다른 오퍼 세트 유형에는 매개 변수가 포함되어 있지 않지만 을 선택하여 사용자 지정할 수 있습니다. **[!UICONTROL 미리 보기]** 사용 가능한 사전 설정 변경
...
* **이미지 템플릿**: Adobe Dynamic Media Classic에서 다음을 사용하여 이미지 템플릿을 매개 변수화할 수 있습니다. **[!UICONTROL 빌드]** > 템플릿 기본 사항 명령 매개 변수를 통해 템플릿의 구성 요소, 텍스트 프레임의 텍스트, 다른 이미지를 스왑하고 사용자 정의할 수 있습니다. 오퍼 세트의 경우, 예를 들어 템플릿 매개 변수를 사용하여 오퍼 세트의 동일한 이미지에 변형을 만들 수 있습니다. 이미지 템플릿 만들기 및 매개 변수화에 대한 자세한 내용은 [템플릿 매개 변수 만들기](creating-template-parameters.md#creating_template_parameters).
...
오퍼 세트를 만들 때 **[!UICONTROL 저장 후 게시]** 옵션은 다음과 같은 방법으로 세트 및 세트 멤버에 영향을 줍니다.
...
1. 이미지 또는 비디오를 선택하고 을(를) 선택합니다(선택 사항). **[!UICONTROL 미리 보기]**. 오퍼 미리 보기 페이지에서 선택한 이미지 또는 비디오의 크기와 모양을 변경할 수 있습니다. 또는 오퍼 세트의 모든 이미지 또는 비디오를 변경할 수 있습니다.
   ...
   * 선택한 사전 설정을 오퍼 세트의 모든 오퍼에 적용하려면 **[!UICONTROL 모두 사전 설정 선택]** 확인란.

   선택 **[!UICONTROL 저장]** 을 클릭하여 이미지 또는 비디오 오퍼에 대한 변경 사항을 저장합니다. 그런 다음 을 선택합니다 **[!UICONTROL 닫기]** Test&amp;Target 오퍼 집합 페이지로 돌아갑니다.

1. 오퍼 세트에 대한 오퍼를 만들고 다른 이미지에 대한 이미지 사전 설정을 선택한 후에는 **[!UICONTROL 저장 후 게시]** 이(가) 선택되었습니다(기본값).
...
1. 오퍼 세트를 편집하려면 그리드 보기 또는 목록 보기에서 오퍼 세트를 표시한 다음 해당 오퍼를 선택합니다 **[!UICONTROL 편집]** 롤오버 단추.
