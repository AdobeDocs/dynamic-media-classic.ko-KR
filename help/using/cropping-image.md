...
이미지 주위의 공백을 제거하거나 이미지 영역을 자르려면 해당 영역을 자를 수 있습니다.
...
1. 이미지를 자르려면 롤오버 **[!UICONTROL 편집]** 단추를 선택한 다음 **[!UICONTROL 자르기]**&#x200B;를 선택하거나 [찾아보기] 패널 세부 정보 보기에 표시하고 **[!UICONTROL 자르기]** 단추를 선택하십시오.
...
1. 이미지를 자르려면 롤오버 **[!UICONTROL 편집]** 단추를 선택하고 **[!UICONTROL 자르기]**&#x200B;를 선택하거나 [찾아보기] 패널 세부 정보 보기에 표시하고 **[!UICONTROL 자르기]**&#x200B;를 선택합니다.

1. 자르기 편집기 창에서 자르기 상자 내부에 유지할 이미지 부분을 배치합니다. **[!UICONTROL 저장]**&#x200B;을 선택하고 이미지를 자른 후에도 상자 안에 나타나는 내용이 남아 있습니다.
1. 자르기 영역을 조정하려면 다음 중 하나를 수행합니다.

   * 상자 측면이나 모서리를 드래그합니다. 크기를 변경하고 자르기 상자의 종횡비(모양)를 유지하려면 Shift 키를 누른 상태에서 드래그합니다.
   * [크기] 상자에 픽셀 측정값을 입력합니다.
   * 자르기 상자를 끌어서 이동합니다. 포인터를 상자 경계 안으로 이동합니다. 이동 포인터가 표시되면 상자를 이미지의 새 위치로 드래그합니다.
