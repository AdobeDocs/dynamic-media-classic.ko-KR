...
| 채우기 방법 | 필수. <br>설정한 모퉁이 위치에서 픽셀 투명도를 제어합니다.<br>다음 채우기 방법 중에서 선택할 수 있습니다.<br>· <b>채우기</b>: 지정한 모퉁이와 일치하고 연결된 모든 픽셀을 투명하게 바꿉니다.<br>· <b>픽셀 일치</b>: 이미지의 위치에 관계없이 일치하는 모든 픽셀을 투명하게 바꿉니다. |
