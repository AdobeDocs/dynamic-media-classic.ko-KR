...
**_Windows®에만 적용됨 - 데스크톱 앱 UI를 통해 업로드할 수 있는 파일 수에 제한이 있습니까?_**<br>예, 데스크톱 앱 UI를 사용하여 한 번에 최대 150개의 파일을 업로드할 수 있습니다.

**_Windows® 및 macOS에 적용됨 - 회사 간에 전환하려면 어떻게 해야 합니까?_**<br>회사 간에 전환하려면 다음을 수행하십시오.
...
**_에셋의 게시 상태(녹색 표시기)가 올바르게 반영되지 않았습니다._**<br>브라우저 사용자 인터페이스에서 에셋의 올바른 게시 상태를 보려면 UI에 다시 로그인해야 합니다. 데스크톱 앱에서 Adobe은 도구 모음에**[!UICONTROL 없음 선택&#x200B;]**단추 오른쪽에**[!UICONTROL 새로 고침&#x200B;]**아이콘을 도입했습니다. 지정된 페이지에 있는 모든 자산의 최신 상태를 보려면**[!UICONTROL 새로 고침&#x200B;]**아이콘을 탭하세요. 브라우저 UI에서와 같이 다시 로그온할 필요가 없습니다.

![새로 고침 아이콘](/help/using/assets/refresh-icon1.png)
*새로 고침 아이콘*

**_데스크톱 앱에서 일괄처리 집합 사전 설정이 작동하지 않습니다._**<br>업로드 > 작업 옵션 > 일괄처리 집합 사전 설정]**을 누릅니다.**[!UICONTROL 관련**[!UICONTROL 일괄처리 집합 사전 설정&#x200B;]**이 활성화되어 있는지 확인하십시오.**[!UICONTROL 업로드 저장 및 제출&#x200B;]**을 클릭합니다.
