...
견본 집합의 이미지에 대해 확대/축소 타겟과 이미지 맵을 정의하면 해당 타겟과 맵이 견본 집합 뷰어에 표시됩니다. 예를 들어 사용자는 견본 집합 뷰어에서 이미지 맵을 선택하고 항목에 대한 정보가 있는 웹 사이트에서 새 페이지를 열 수 있습니다. 사용자는 견본 집합 뷰어에서 대상 썸네일 이미지를 선택하고 이미지의 일부로 자동으로 확대/축소할 수 있습니다.
