...
+++**다음과 같음 [!DNL Dynamic Media] 업그레이드할 수 있도록 필요한 기능이 있습니까? 에서 사용할 수 있는 기능 [!DNL Dynamic Media] 날짜 [!DNL Experience Manager] 에셋?**
다음을 참조하십시오. [기능 비교](/help/using/upgrade-feature-comparison.md) 자세히 알아볼 수 있는 페이지입니다.
