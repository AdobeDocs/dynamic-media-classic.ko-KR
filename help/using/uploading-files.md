...
* **작업**: 전체 업로드 작업에 영향을 주는 옵션을 선택하려면 **[!UICONTROL 작업]**&#x200B;을 선택하십시오.
  ...
  일반 설정에서 *기본 업로드 옵션* 대화 상자를 사용하여 작업을 업로드하는 **[!UICONTROL 기본]** 옵션을 선택할 수도 있습니다. **[!UICONTROL 설정]** > **[!UICONTROL 응용 프로그램 설정]** > **[!UICONTROL 일반 설정]** > **[!UICONTROL 기본 업로드 옵션]**(으)로 이동한 다음 원하는 기본 옵션을 설정합니다.
