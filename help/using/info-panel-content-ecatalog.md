...
1. 응답 템플릿을 선택합니다.
   ...
   * 응답 템플릿을 만들려면 다음을 선택합니다. **[!UICONTROL 사용자 정의]**. [사용자 템플릿] 상자에 템플릿 XML 정의를 입력합니다. 사전 설정 템플릿을 고유한 템플릿의 기초로 사용할 수 있습니다.
...
1. (선택 사항) 선택 **[!UICONTROL 지금 업데이트 실행]** 따라서 콘텐츠를 즉시 업데이트할 수 있습니다.
