...
관리자는 사용자를 추가 및 관리하고, 사용자가 암호를 변경할 수 있는지 여부를 결정하고, 사용자 정보를 편집하고, 사용자 목록을 업로드할 수 있습니다. 이러한 작업은 [사용자 관리] 화면에서 수행합니다. 이 화면에 액세스하려면 다음으로 이동합니다. **[!UICONTROL 설정]** > **[!UICONTROL 응용 프로그램 설정]** > **[!UICONTROL 관리 설정]** > **[!UICONTROL 사용자 관리]**.
...
>[!NOTE]
>
>암호를 변경할 수 있는 Media Portal 사용자는 다음을 선택하여 변경할 수 있습니다. **[!UICONTROL 설정]** > **[!UICONTROL 개인 설정]** 개인 설정 화면에서 암호 변경.
...
1. (선택 사항) 선택 **[!UICONTROL 이메일 설정]** 기본 설정과 다른 전자 메일 설정을 선택합니다.
...
1. 다음으로 이동 **[!UICONTROL 설정]** > **[!UICONTROL 응용 프로그램 설정]** > **[!UICONTROL 관리 설정]** > **[!UICONTROL 사용자 관리]**.
1. 다음에서 **[!UICONTROL 사용자 역할별]** 드롭다운 목록에서 Media Portal 사용자 역할의 이름을 선택한 다음 를 선택합니다. **[!UICONTROL 새로 고침]** Media Portal 사용자의 한 클래스 이름을 표시합니다.
