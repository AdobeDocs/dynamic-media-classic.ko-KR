...
표준화된 속성에 대한 자세한 내용은 [Adobe XMP 개발자 센터](https://www.adobe.com/devnet/xmp.html)를 참조하십시오.
...
예를 들어 `dc:subject`에 대한 값 `Hello\, World!,back\\slash,foo`이(가) 포함된 메타데이터 가져오기 파일은 자산에 세 개의 XMP 키워드를 설정합니다. `Hello, World!,` `back\slash,` 및 `foo`.
