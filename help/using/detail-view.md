...
![세부 정보 보기](/help/using/assets/image_0.img.png)
...
* **게시할 항목**: 이름 왼쪽에 있는 **[!UICONTROL `Publish`]** 아이콘을 선택하거나 **[!UICONTROL 파일]** > **[!UICONTROL 게시]** 또는 **[!UICONTROL 파일]** > **[!UICONTROL 게시 취소]**(으)로 이동합니다.
