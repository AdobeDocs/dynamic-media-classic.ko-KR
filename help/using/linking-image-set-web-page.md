...
이미지 집합을 게시한 후 웹 사이트 또는 응용 프로그램에서 사용할 연결된 URL 또는 포함 코드를 복사할 수 있습니다. 그런 다음 URL을 배포하거나 필요에 따라 포함된 코드를 붙여넣어 사용자가 웹 사이트 또는 애플리케이션에서 이미지 세트를 볼 수 있도록 할 수 있습니다.
...
1. [자산 찾아보기] 패널 위의 도구 모음 오른쪽에서 다음 중 하나를 수행합니다.
   ...
   * **[!UICONTROL 눈금 보기]**&#x200B;를 선택합니다. [자산 찾아보기] 패널에서 단일 자산을 두 번 클릭하여 [세부 사항 보기]에서 엽니다. 오른쪽의 **[!UICONTROL URL 및 포함 코드]** 패널에서 원하는 뷰어의 오른쪽에 있는 **[!UICONTROL URL 복사]**&#x200B;를 선택합니다.
...
이미지 세트를 배포하는 표준 방법은 웹 페이지에 링크(탐색 아이콘 사용)를 배치하는 것입니다. 선택하면 링크가 팝업 확대/축소 창에 이미지 세트를 표시하는 JSP(동적 페이지)를 시작합니다. 확대/축소 링크는 실제 확대/축소 기능이 포함된 팝업 창을 엽니다.

자세한 내용 및 코드 샘플은 Adobe 뷰어 참조 안내서에서 [포함된 HTML5 확대/축소 뷰어](https://experienceleague.adobe.com/en/docs/dynamic-media-developer-resources/library/viewers-aem-assets-dmc/zoom/c-html5-20-zoom-viewer-about#section-e1c3106f5b3e445d9b95be337c2f94e2)를 참조하십시오.

## 이미지 집합 뷰어의 포함된 코드 복사 {#copying-the-embed-code-of-an-image-set-viewer}

포함된 코드 기능을 사용하면 선택한 이미지 세트의 뷰어 코드를 검토할 수 있습니다. 또한 코드를 클립보드에 복사하여 뷰어의 배포를 위해 웹 페이지에 붙여넣을 수 있습니다. 코드 편집은 [임베드 코드] 대화 상자에서 허용되지 않습니다.

**이미지 집합 뷰어의 포함된 코드를 복사하려면:**

1. [자산 찾아보기] 패널의 [표시] 드롭다운 목록에서 **[!UICONTROL 이미지 집합]**&#x200B;을 선택합니다.
1. 왼쪽의 에셋 라이브러리 패널에서 복사할 포함 코드가 있는 이미지 세트가 포함된 에셋 폴더로 이동합니다.
1. [자산 찾아보기] 패널 위의 도구 모음 오른쪽에서 다음 중 하나를 수행합니다.
...
1. **[!UICONTROL 포함 코드]** 대화 상자에서 **[!UICONTROL 클립보드에 복사]**&#x200B;를 선택합니다.

   **[!UICONTROL 포함 코드]** 대화 상자에서는 코드를 편집할 수 없습니다.
