...
Adobe Dynamic Media Classic의 파일 자산은 폴더에 보관됩니다. 이러한 폴더는 에셋 라이브러리 패널에 알파벳순으로 나열됩니다. 컴퓨터 또는 네트워크에서 Adobe Dynamic Media Classic으로 파일을 업로드하기 전에 파일을 저장할 폴더의 이름을 지정하라는 메시지가 표시됩니다. 파일을 업로드하기 전에 해당 폴더를 만듭니다.
...
* **하위 폴더 표시**: **[!UICONTROL 확장된 폴더]** 아이콘을 선택하여 폴더에 하위 폴더를 표시합니다. 이 아이콘은 폴더 이름 왼쪽에 있습니다.

* **폴더 이동**: 폴더를 드래그 앤 드롭하여 이동하거나 **[!UICONTROL 파일]** > **[!UICONTROL 폴더 이동]**&#x200B;을 선택합니다.

* **폴더 숨기기**: 하위 폴더를 축소하여 보기에서 숨기려면 **[!UICONTROL 축소된 폴더]** 아이콘을 선택합니다. 이 아이콘은 폴더 이름 왼쪽에 있습니다.

* **폴더 열기**: 내용을 [찾아보기] 패널에 표시하려면 폴더를 선택합니다.

>[!TIP]
>
>왼쪽의 **[!UICONTROL 확장]** 또는 **[!UICONTROL 축소]** 컨트롤을 선택하여 자산 라이브러리를 숨기거나 표시할 수 있습니다. [찾아보기] 패널에서 더 많은 공간이 필요할 때 [에셋 라이브러리] 패널을 축소합니다.
...
* **삭제**: **[!UICONTROL `Remove Folder`]** 단추를 선택합니다. 삭제된 폴더의 Assets이 삭제된 항목 폴더로 이동됩니다. 여기서 자산을 복구할 수 있습니다.

* **이름 바꾸기**: 이름을 두 번 클릭하고 새 이름을 입력합니다.

>[!NOTE]
>
>폴더 또는 에셋을 복사하면 Adobe Dynamic Media Classic에 중복된 폴더 및 에셋이 생성되며, 이는 지원되지 않습니다.
