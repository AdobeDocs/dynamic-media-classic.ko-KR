...
seo-title: 확대/축소 뷰어를 웹 페이지에 연결
description: 널
seo-description: 확대/축소 뷰어를 웹 페이지에 연결하는 방법을 알아봅니다.
...
웹 사이트와 애플리케이션은 URL 문자열 또는 임베디드 코드를 통해 마스터 이미지 및 관련 확대/축소 타겟, 확대/축소 뷰어 사전 설정을 비롯한 다이내믹 미디어 이미지 서버 컨텐츠에 액세스합니다. 이러한 URL 문자열은 게시 프로세스 중에 활성화됩니다. 웹 페이지와 애플리케이션에 이 URL 문자열 또는 임베드된 코드를 배치하려면 Scene7 Publishing System에서 복사합니다.
...
자세한 내용 및 코드 샘플은 Adobe Viewer 참조 안내서의 [HTML 5 기본 확대/축소 뷰어 임베딩을 참조하십시오](https://marketing.adobe.com/resources/help/en_US/s7/viewers_ref/c_html5_20_basic_zoom_viewer_about.html).
