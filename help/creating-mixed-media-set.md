---
title: 혼합 미디어 집합 만들기
description: Dynamic Media Classic에서 혼합 미디어 세트를 만드는 방법을 알아봅니다.
...
1. **[!UICONTROL 빌드]** > **[!UICONTROL 혼합 미디어 세트]**&#x200B;로 이동합니다.
...
1. **[!UICONTROL 저장]**&#x200B;을 선택합니다.
   ...
   이미지 세트 뷰어에서 콤보 이미지 세트의 모양을 보려면 **[!UICONTROL 미리 보기]**&#x200B;를 선택합니다.
...
1. 혼합 미디어 세트의 롤오버 **[!UICONTROL 편집]** 단추를 선택합니다.
1. 다음 중 하나를 수행합니다.
