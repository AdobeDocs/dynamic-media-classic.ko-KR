...
1. 이동 **[!UICONTROL 빌드]** > **[!UICONTROL 혼합 미디어 집합]**.
...
1. 선택 **[!UICONTROL 저장]**.
1. 혼합 미디어 세트를 저장할 폴더를 선택한 다음 해당 세트의 이름을 입력합니다.
1. 선택 **[!UICONTROL 저장]**.

   이미지 세트 뷰어에서 콤보 이미지 세트의 모양을 보려면 **[!UICONTROL 미리 보기]**.
...
1. 혼합 미디어 세트의 롤오버를 선택합니다 **[!UICONTROL 편집]** 버튼을 클릭합니다.
1. 다음 중 하나를 수행합니다.

   * 항목을 제거하려면 항목을 선택하고 을 선택합니다 **[!UICONTROL 삭제]**.
