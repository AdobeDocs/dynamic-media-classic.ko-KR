...
description: Dynamic Media Classic Adobe 개요
...
모든 장치 및 화면에 다이내믹한 풍부한 콘텐츠를 업로드, 관리, 개선 및 게시할 수 있는 최고의 온디맨드 미디어 간 게시 시스템인 Adobe Adobe Dynamic Media Classic을 시작합니다. Adobe Dynamic Media Classic 솔루션은 다음과 같습니다.
...
* 미디어 포털: 셀프 서비스 환경에서는 포털 사용자에게 자산을 업로드, 탐색, 검색, 미리 보기 및 내보내기에 쉽게 액세스할 수 있도록 관리자가 제어하는 &quot;보기&quot;를 Adobe Dynamic Media Classic 자산에 제공합니다.
