...
템플릿의 변형을 관리하려면 템플릿 집합을 만듭니다. 사이트에서 코드를 변경하지 않고 어떤 변형을 사용할지 제어할 수 있습니다. 이 방법은 컨텐츠 관리자가 웹 코드의 URL을 변경하지 않고도 컨텐츠를 회전하는 데 도움이 됩니다.

유니버설 URL은 세트에 나열되는 순서에 따라 페이지에 나타나는 템플릿 변형을 표시하는 데 사용됩니다. 템플릿 집합 목록의 상단에 있는 템플릿은 항상 게시됩니다.
...
1. 템플릿 속성을 수정하고 **[!UICONTROL 다른 이름으로 저장을 클릭하여 다른 버전을 만듭니다.]**
