---
title: 시스템 요구 사항
description: 'Media Portal을 사용하는 최적의 경험을 위한 시스템 요구 사항에 대해 알아보십시오. '
...
Dynamic Media Classic Media Portal을 사용하는 최상의 환경을 얻으려면 시스템이 다음 시스템 요구 사항 및 제안을 충족하는지 확인하십시오.
