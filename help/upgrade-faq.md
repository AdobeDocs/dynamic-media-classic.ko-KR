...
* 캠페인 에셋을 제품 정보와 결합하여 클릭-장바구니 간소화합니다.
...
60GB의 스토리지가 포함되어 있습니다. 250GB의 블록 단위로 추가 스토리지를 구입할 수 있습니다. 현재 스토리지 할당량을 얻으려면 계약 세부 사항을 확인하십시오.
...
다음을 참조하십시오. [기능 비교](/help/upgrade-feature-comparison.md) 페이지를 가리키도록 업데이트하는 중입니다.
...
다음 항목도 참조하십시오. [기능 비교](/help/upgrade-feature-comparison.md) 페이지를 가리키도록 업데이트하는 중입니다.
