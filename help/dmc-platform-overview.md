...
![Adobe Dynamic Media Classic 워크플로 프로세스](/help/assets/gs_workflow.png)
...
![Adobe Dynamic Media Classic은 동일한 1차 이미지를 크기와 형식이 다른 다양한 미디어에 제공할 수 있습니다.](/help/assets/gs_dynamic_publishing.png)
