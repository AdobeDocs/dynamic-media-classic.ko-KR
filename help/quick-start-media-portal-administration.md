...
자세한 내용은 [Media Portal 사용자 추가 및 관리](adding-media-portal-users.md#adding_and_managing_media_portal_users).
...
자세한 내용은 [FTP 계정 관리](ftp-accounts.md#managing_ftp_accounts).
...
Media Portal 사용자는 파일을 내보낼 때 파일의 형식을 다시 지정하고 원래 기본 파일을 내보낼 수 있습니다. 이 경우 사용자가 파일을 내보낼 수 있습니다. 관리자는 사용자가 파일을 내보내는 방법을 결정합니다. 

자세한 내용은 [Media Portal 사용자가 사용할 수 있는 내보내기 옵션을 지정합니다](specifying-export-options-available-media.md#specifying_export_options_available_to_media_portal_users).
...
자세한 내용은 [Media Portal 페이지 사용자 지정](customizing-media-portal-screen.md#customizing_the_media_portal_screen).
