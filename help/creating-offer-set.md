...
* **이미지**&#x200B;오퍼 세트에 사용할 이미지를 결합할 수 있습니다. 각 이미지에는 세트에 다른 오퍼가 포함됩니다.
...
1. **작성** > **Test&amp;Target 오퍼 집합**&#x200B;을 클릭합니다.
   ...
   [테스트 및 Target 오퍼 세트] 페이지에는 오퍼 세트의 오퍼가 나열됩니다. 목록에서 첫 번째 항목은 개체입니다.
...
1. **저장** 또는 **다른 이름으로 저장**&#x200B;을 클릭하여 오퍼를 오퍼 집합의 일부로 저장합니다.
   ...
   [테스트 및 Target 오퍼 세트] 페이지에는 만든 오퍼가 나열됩니다.
...
1. 오퍼 세트에 사용할 이미지나 비디오를 조합합니다. [테스트 및 Target 오퍼 세트] 화면이나 [격자 보기] 또는 [목록 보기]에서 시작하여 다음 방법 중 하나를 사용합니다.

   * **[테스트 및 Target 오퍼 세트] 화면**[ **[!UICONTROL 빌드] > [테스트 및 Target 오퍼 세트]를 클릭합니다]**. 이미지나 비디오를 화면으로 드래그합니다. 다양한 크기의 비디오나 이미지를 만들려면 이미지나 비디오의 여러 복사본에서 끌어 각 크기를 개별적으로 설정합니다.

   * **격자 또는 목록 보기**&#x200B;이미지나 비디오를 선택한 다음 **[!UICONTROL 빌드 > 테스트 및 Target 오퍼 세트를 클릭합니다]**.
...
1. [Target 오퍼 세트] 페이지에서 다음 중 하나를 수행합니다.
   ...
   * **오퍼 제거**&#x200B;오퍼를 선택한 다음 
**세트에서 오퍼를 제거하려면** 삭제합니다.
   * **오퍼**&#x200B;추가오퍼를 추가하는 방법은 작업 중인 오퍼 세트 유형에 따라 달라집니다.
   * **템플릿**&#x200B;클릭 
**추가 및 미리**&#x200B;보기와 오퍼 추가 및 미리 보기 페이지에서 다른 오퍼를 만듭니다.
