...
Dynamic Media Classic은 오늘날 가장 일반적인 인코딩 설정을 반영하는 사전 정의된 비디오 인코딩 사전 설정 라이브러리를 제공합니다. 이 인코딩 사전 설정은 타겟 화면에서의 재생에 최적화되어 있습니다. 또한 관리자는 자신만의 비디오 인코딩 사전 설정을 만들어 비디오의 크기 및 재생 품질을 최종 사용자에게 맞게 사용자 지정할 수 있습니다. Dynamic Media Classic에서 바로 사용할 수 있는 모든 비디오 인코딩 사전 설정 또는 MP4 파일 포맷으로 비디오를 출력할 수 있습니다.
...
Dynamic Media Classic에서 업로드 및 인코딩하는 비디오 자산의 경우 비디오는 다음 파일 형식으로 제공됩니다.
