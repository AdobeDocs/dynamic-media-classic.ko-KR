...
### 비디오 인코딩 사전 설정 목록을 필터링합니다. {#filtering-the-list-of-video-encoding-presets}
...
1. Dynamic Media Classic Adobe의 전역 탐색 막대에서 **[!UICONTROL 설정]** > **[!UICONTROL 애플리케이션 설정]** > **[!UICONTROL 비디오 사전 설정]** > **[!UICONTROL 응용 비디오 사전 설정]** 또는 **[!UICONTROL 단일 인코딩 사전 설정]**&#x200B;으로 이동합니다.
...
>[!MORELIKETHIS]
>
>* [빠른 시작: Dynamic Media Classic의 비디오](quick-start-video.md#quick-start-video)
