...
이미지에서 공백 픽셀을 자동으로 자르려면 [업로드 작업 옵션] 대화 상자에서 **[!UICONTROL 자르기 옵션]**&#x200B;을 클릭합니다. **[!UICONTROL 자르기]** 드롭다운 목록에서 **[!UICONTROL 재단]**&#x200B;을 선택합니다. 다음 선택 사항을 선택합니다.

* **기준 재단**  - 이 드롭다운 목록에서 색상 또는 투명도를 기준으로 자르는지 여부를 선택합니다.

   * **색상**  - 색상 옵션 **** 을 선택합니다. 그런 다음 **[!UICONTROL 코너]** 드롭다운 목록에서 자르려는 공백 색상을 가장 잘 나타내는 색상이 있는 이미지 모서리를 선택합니다.
...
Scene7 Publishing System 및 이미지 서버에서 [이미지 선명하게 하기](/help/assets/s7_sharpening_images.pdf)도 참조하십시오.
