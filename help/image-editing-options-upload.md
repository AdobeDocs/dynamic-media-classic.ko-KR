...
| 언샵 마스크 옵션 | 설명 |
|--- |--- |
| 금액 | 가장자리 픽셀에 적용되는 대비 양을 제어합니다.<br><br>효과의 강도로 생각하십시오. Dynamic Media Classic의 언샵 마스크 값과 Adobe Photoshop의 금액 간의 주요 차이점은 Photoshop의 양 범위는 1%에서 500%입니다. 반면 Dynamic Media Classic에서는 값 범위가 0.0에서 5.0입니다. Dynamic Media Classic의 5.0은 Photoshop의 대략적인 500%와 같습니다.0.9의 값은 90%와 같은 값입니다. |
