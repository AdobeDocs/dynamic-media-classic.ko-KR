...
seo-title: Adobe Dynamic Media Classic 데스크탑 앱 - 지금 사용 가능
description: 널
...
이제 Dynamic Media Classic 사용자는 브라우저의 Adobe Flash 기술에 더 이상 의존하지 않는 새로운 데스크탑 앱 환경에 액세스할 수 있습니다.

이 새 앱은 이제 Windows 및 macOS에서 사용할 수 있습니다.

>[!IMPORTANT]
>
>2020년 10월 1일까지 새로운 Adobe Dynamic Media Classic 데스크탑 앱을 설치하는 것이 좋습니다. 그렇게 하면 2020년 12월 31일 Adobe Flash Player이 중단되기 전에 원활한 전환이 보장됩니다. 이 날짜에 더 이상 제품의 Dynamic Media Classic으로 레이블이 지정된 Adobe Dynamic Media Classic 사용자 인터페이스의 브라우저 버전에 로그인할 수 없습니다.

이제 [새로운 Dynamic Media Classic 로그인 환경을 위한 FAQ를 참조하십시오.](/help/new-ui-2020.md)
...
1. 다운로드한 설치 프로그램에 따라 다음 중 하나를 수행합니다.
   ...
   * **macOS** - 드래그 앤 **[!UICONTROL 드롭으로 설치]** 대화 상자에서 **[!UICONTROL Adobe Dynamic Media Classic]** 을 **[!UICONTROL 응용 프로그램]**&#x200B;에 드래그하여 놓습니다.
...
* Dynamic Media Classic을 다시 시작한 다음 평소대로 로그인하여 새 회사와 공동 작업을 수행합니다.

## 팁 및 기법

**_Dynamic Media Classic의 랜딩 페이지에서 미디어 장바구니 패널을 볼 수 없습니다._**<br>Dynamic Media Classic에서**[!UICONTROL 설정 > 개인 설정을 누릅니다&#x200B;]**. 브라우저 섹션에서 미디어 포털 기능**[!UICONTROL 표시&#x200B;]**(선택)가 선택되어 있는지 확인합니다. 저장**[!UICONTROL > 닫기를 누릅니다&#x200B;]**.
