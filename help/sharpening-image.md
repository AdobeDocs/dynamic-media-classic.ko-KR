...
이미지를 선명하게 하려면 롤오버 **[!UICONTROL 편집]** 단추를 클릭하고 **[!UICONTROL 선명하게]**&#x200B;를 선택하거나 [세부 사항 보기]에서 [찾아보기] 패널에서 연 다음 **[!UICONTROL 선명하게]**&#x200B;를 클릭합니다. 선명하게 하기 명령이 있는 [선명도 편집기] 페이지가 열립니다. 명령을 선택한 다음 **[!UICONTROL 저장]**&#x200B;을 클릭합니다.
...
* **Bilinear**  - 가장 빠른 재샘플링 방법 일부 앨리어싱 가공물들은 눈에 띄습니다.
...
Adobe Dynamic Media Classic에서 이미지를 선택하고 세부 사항 보기로 이동한(를 두 번 클릭하거나 **[!UICONTROL 세부 사항 보기]** 단추 클릭)후 **[!UICONTROL 선명하게]**&#x200B;를 클릭합니다. 매개 변수를 변경한 다음 **[!UICONTROL 저장]**&#x200B;을 클릭합니다. 이 프로세스는 선명하게 하기 수정자 또는 이미지 사전 설정과 같은 URL에서 호출하는 명령 대신 이미지 서버에 이러한 선명하게 하기 매개 변수를 사용하도록 지시합니다. 변경 사항이 적용되는지 확인하려면 게시하십시오.
