...
설명서의 목표는 최신 설명서를 사용자에게 최대한 신속하게 전달하는 것입니다. 따라서 Adobe은 정확하고 유용한 문서의 우선 순위를 두며 지속적으로 업데이트하고 개선하기 위해 노력합니다.
...
Adobe은 해당 설명서에 대한 기여를 환영하지만 설명서에 대한 모든 기여(가져오기 요청 또는 문제 형식)는 Adobe의 기여 및 설명서 표준을 준수해야 합니다.
...
가져오기 요청은 영향을 받는 페이지를 참조하므로 가져오기 요청에는 적용되지 않습니다.
